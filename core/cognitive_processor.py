    ...
    def apply_analyzed(
        ...
        if (
            ...
            try:
                ...
                return {
                    "status": "INVALID_COGNITION_ANALYSIS",
                    "item": failed,
                }

            # Apply cognitive analysis to self_state
            cognitive_state = self.self_state.get(
                "cognitive_state", {}
            )
            cognitive_state.update(analysis.get(
                "cognitive_updates", {}
            ))
            self.self_state.set(
