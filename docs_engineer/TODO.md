...
- [ ] Д2 ЧАСТИЧНО: зацикленность 8B смягчена правилами промпта;
  радикальное решение — 70B на рефлексию (уже настроено) и/или
  расширение памяти до 16 ГБ для локальных моделей побольше.
